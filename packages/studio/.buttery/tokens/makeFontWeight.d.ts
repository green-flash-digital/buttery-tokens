export type FontFamilyAndWeight = "Poppins-bold" | "Poppins-semiBold" | "Poppins-medium" | "Poppins-regular" | "Poppins-light" | "Inter-bold" | "Inter-semiBold" | "Inter-medium" | "Inter-regular" | "Inter-light" | "Mulish-bold" | "Mulish-semiBold" | "Mulish-medium" | "Mulish-regular" | "Mulish-light" | "Consolas-bold" | "Consolas-semiBold" | "Consolas-medium" | "Consolas-regular" | "Consolas-light";
 ...
 * ```
 */
export declare const makeFontWeight: MakeFontWeight;
