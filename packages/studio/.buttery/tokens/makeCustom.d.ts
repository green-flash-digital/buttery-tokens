export type CustomTokens = "layout-header-height" | "layout-max-width" | "layout-gutters" | "layout-section-title-height" | "modal-gutters";
 ...
 * ```
 */
export declare const makeCustom: MakeCustom;
